            ...
            if args.sockettimeout:
                if args.sockettimeout > 0.0:
                    ...
                    print('--sockettimeout|-t must not be negative ({}). '
                          'Setting default to 600.0'.format(args.sockettimeout),
                          file=sys.stderr)
